...
setup(
    ...
    entry_points={
        "databroker.handlers": [
            ...
            "AD_TIFF_ND_TS = area_detector_handlers.handlers:AreaDetectorTiffNDTimestampHandler",
            ...
            "AD_HDF5_ND_TS = area_detector_handlers.handlers:AreaDetectorHDF5NDTimestampHandler",
